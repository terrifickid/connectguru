...
import { CircleBackground } from "@/components/pocket/CircleBackground";
...
import {
  ...
  TransistorLogo,
  TupleLogo,
} from "@/components/pocket/StockLogos";
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          <h2 className="text-3xl font-medium tracking-tight text-white">
            Empower your journey with Al-driven insights, expert guidance, and a
            global network of innovators
          </h2>
          <p className="mt-2 text-lg text-gray-400">
            <b class="font-medium">Connect Guru</b> is a global platform
            transforming how founders, innovators, and companies connect,
            collaborate, and grow. By combining cutting-edge AI with human
            expertise, we streamline decision-making, foster impactful
            relationships, and unlock new opportunities for sustainable
            innovation.
          </p>
        </div>
      </Container>
